...
/**
 * scoped_seqlock_read - execute the read side critical section without
 *                       manual sequence counter handling or calls to other
 *                       helpers
 * @_seqlock: pointer to seqlock_t protecting the data
 * @_target: one of {ss_lock, ss_lock_irqsave, ss_lockless} indicating
